...
function draw(){
if(game_status == "start" | game_status == "restart")
 {
   background(0); 
   ...
   rect(paddle1X,right_wrist_y,paddle1,paddle1Height,100);
...
if(pcscore == 3){
    ...
    text("Click on Reset and try your best!",width/2,height/2+30);
    game_status = "nope"
    pcscore = 0;
}
